    ...
    public boolean sendMessage(int service, int what, ByteBuffer content) {
        ...
        try {
            synchronized (mLock) {
                ...
                //mLogger.log(String.format("Send message %d,%d,%d" , service,what, content == null? 0 : (content.limit() - content.position())));
                if (content == null) {
                    ...
                    if (contentRemaining > Protocol.MAX_CONTENT_SIZE) {
                        ...
                        throw new IllegalArgumentException("Message content too large: "
                          ...
                          */
                    	mLogger.logError("Message content too large:  discard");
                    	return true;
                    }
            ...
            mLogger.logError("Send message failed: " + " Service=" + service + " / What=" + what +ex);
            return false;
        }
    }
